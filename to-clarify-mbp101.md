...
* Is the Renesas H8/2113 (GMUX chip) programmable from either ME/SMM/SPI ROM/macOS w/o HW access? If yes, how? Is there any GMUX FW update??? (This might allow for rapidly strobing the display backlight ;) )
